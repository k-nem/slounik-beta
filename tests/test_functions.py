# Unit tests assume default configs, i.e., the stop-word list
...
class testClass(unittest.TestCase):
    ...
    def testFormSearchComplex(self):
        ...
        """
        requested = formSearch(query = 'Е??а', keepLetterCase = True, l_gender = 'Fem')
    ...
    def testFormByIDComplex(self):
        ...
        """
        requested = formByID(14233, toConllu = True, includeForm = False)
    ...
    def testFormSearchComplex(self):
        ...
        """
        requested = lemmaSearch(query = 'аа*й', Animaсy = True, POS = 'NOUN')
    ...
    def testAnnotateToken(self):
        ...
        """
        requested = annotateToken('прытрудна')
    ...
    def testAnnotateTokenConllu(self):
        ...
        """
        requested = annotateToken('прытрудна', toConllu = True)
    ...
    def testAnnotateSentence(self):
        ...
        """
        requested = annotateSentence(tokenize('А ты?😎'))
    ...
    def testAnnotateSentenceConllu(self):
        ...
        """
        requested = annotateSentence(tokenize('А ты?😎'), toConllu = True, extended = False)
    ...
    def testSplitSentences(self):
        ...
        requested = splitSentences(tokenize(sample))
    ...
    def testAnnotateText(self):
        ...
        """
        requested = annotateText('Аня была там у 2023 г.')
        correct = {'Paragraphs': {1: {'Text': 'Аня была там у 2023 г.', 'Sentences': {1: {'Text': 'Аня была там у 2023 г.', 'Tokens': {1: {'Form': 'Аня'}, 2: {'Form': 'была', 'Results': {1: {'FormData': {'ID': 1927724, 'Form': 'была', 'Accent': '4'}, 'LemmaData': {'ID': 68873, 'Lemma': 'было', 'POS': 'PART'}, 'Variant': 3}, 2: {'FormData': {'ID': 3406054, 'Form': 'была', 'Accent': '4', 'Gender': 'Fem', 'Number': 'Sing', 'Tense': 'Past'}, 'LemmaData': {'ID': 203078, 'Lemma': 'быць', 'POS': 'VERB', 'InflClass': 'Com', 'Aspect': 'Imp', 'SubCat': 'Intr'}, 'Variant': 1}}}, 3: {'Form': 'там', 'Results': {1: {'FormData': {'ID': 1927813, 'Form': 'там', 'Accent': '2'}, 'LemmaData': {'ID': 68957, 'Lemma': 'там', 'POS': 'PART'}, 'Variant': 1}, 2: {'FormData': {'ID': 3312240, 'Form': 'там', 'Accent': '2', 'Degree': 'Pos'}, 'LemmaData': {'ID': 194324, 'Lemma': 'там', 'POS': 'ADV'}, 'Variant': 1}}}, 4: {'Form': 'у', 'Results': {1: {'FormData': {'ID': 1928071, 'Form': 'у'}, 'LemmaData': {'ID': 69196, 'Lemma': 'у', 'POS': 'ADP'}, 'Variant': 1}}}, 5: {'Form': '2023', 'Results': {1: {'POS': 'NUM'}}}, 6: {'Form': 'г', 'SpaceAfter': False}, 7: {'Form': '.', 'Results': {1: {'POS': 'PUNCT'}}}}}}}}}
